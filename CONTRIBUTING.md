...
3. Increase the version numbers in any examples files and the [package.json](package.json) and [main ruby file](Adventure.rb) to the new version that this Pull Request would represent. The versioning scheme we use is [SemVer](http://semver.org/).
